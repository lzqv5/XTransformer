<template>
  <div id="shieldDiv">
  <!-- 定义 framework 里 上面一行的三个视图 -->
  <!--<a-row :gutter="[2, 2]"> -->
    <a-row :gutter="[2, 2]">
      <!-- span 定义了 每一个 view 的宽度 -->
      <a-col :span="12">
        <!--<button @click="closeIsShowComponentview()">关闭 isShowComponentview</button>-->
  ...
  <!-- detail view - 用来解释 tokenize, layernorm 以及 attention 中的一些细节 -->
  <!-- <div id='detailview' :z-index='zIndexDetailview'> -->
  <div id='detailview' >
...
export default {
  ...
  methods: {
    ...
    enterDetailView(selectedNode){
      ...
      document.getElementById('shieldDiv').appendChild(this.mask);
    },
    quitDetailView(){
      // 设置各项变量
      this.selectedNode = {};
      ...
      // 移除覆盖物
      document.getElementById('shieldDiv').removeChild(this.mask);
    },
