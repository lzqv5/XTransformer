...
from src.transformer_settings.config import src_vocab_size, tgt_vocab_size, n_layers, d_model, d_ff, n_heads, d_k, dropout
...
def initModel():
    ...
    path = os.path.join(path,'models/NewArc_small_with_NoamOpt_no_LabelSmoothing_model.pth')
    # print(f"Path: {path}")
